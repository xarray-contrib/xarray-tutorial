...
htmlhelp_basename = 'XarrayTutorialdoc'
...
latex_documents = [
    (master_doc, 'XarrayTutorial.tex', 'Xarray Tutorial Documentation',
...
man_pages = [
    (master_doc, 'xarraytutorial', 'Xarray Tutorial Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'XarrayTutorial', 'Xarray Tutorial Documentation',
     author, 'XarrayTutorial', 'One line description of project.',
     'Miscellaneous'),
]